...
const S = {
  page: { maxWidth: 720, margin: '0 auto', padding: '60px 20px 80px' },
  ...
  select: {
    ...
    color: 'var(--text)', fontFamily: 'var(--font-sora)', fontSize: 15, padding: '12px 16px',
    ...
    return (
      <div style={S.page}>
        ...
        <div style={{
          ...
          <p style={{
            fontFamily: 'var(--font-mono)', fontSize: 40, letterSpacing: '0.1em',
            color: expired ? '#F44336' : '#D4A017',
          }}>
            {countdown}
          </p>
          {!expired && (
  ...
  return (
    <div style={S.page}>
      <div style={{ marginBottom: 36 }}>
        <p style={S.sectionLabel}>Self-Service Order Form</p>
      ...
      <div style={{ display: 'flex', gap: 0, marginBottom: 28, border: '1px solid var(--border)', borderRadius: 10, overflow: 'hidden' }}>
        {[
          ...
          { key: 'inbound',  emoji: '↙', label: 'I am abroad — sending HOME to Uganda', sub: 'Family receives MTN MoMo or bank transfer' },
